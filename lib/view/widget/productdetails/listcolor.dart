...
else if(x=='Army camouflage1'||x=='army camouflage1'){y=Color(0xFFA29C09);}else if(x=='Army camouflage'||x=='army camouflage'){y=Color(0xFFC5B620);}else if(x=='Army beige'||x=='army beige'){y=Color(0xFFEEEAD5);} else if(x=='brown'||x=='Brown'){y=Colors.brown;}
