...
class CustomListFavoriteItems1 extends GetView<ItemsControllerImp> {
  final ItemsModel itemsModel;
  final int? itemnum;
  // final bool active;
  const CustomListFavoriteItems1({Key? key, required this.itemsModel ,  this.itemnum}) : super(key: key);
