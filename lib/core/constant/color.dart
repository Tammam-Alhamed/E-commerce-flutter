...
class AppColor {
  ...
  static const Color primaryColor = Color(0xff53b024);
  static const Color secondColor = Color(0xff16a211);
  static const Color fourthColor = Color(0xff0d3056);
  static const Color thirdColor = Color.fromARGB(255, 217, 255, 170);
