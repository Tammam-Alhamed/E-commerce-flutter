...
class AppColor {
  static const Color home = Color(0xb87ca8fa);
  static const Color grey = Color(0xe0568ef8);
  static const Color grey2 = Color.fromARGB(215, 91, 137, 255);
  ...
  static const Color thirdColor = Color(0xca4495ff);
